...
<body> 
    ...
    <main id="main">
        <h1 id="h1">Registar nueva compra</h1>
        <form class="container needs-validation " novalidate>
            ...
            <div class="contenedor-1">
                ...
                <div class="row" action="">
                    ...
                    <div class="col-4">
                        <input class="line1 controls form-control" type="text" name="apellidos" id="line1" placeholder="00000000" required>
                        <div class="invalid-feedback">
                            Campo obligatorio
                        </div>
                    </div>
                    <div class="col-4">
                        <input class="line1 controls form-control" type="text" name="apellidos" id="line1" placeholder="Anónimo" required>
                        <div class="invalid-feedback">
                            Campo obligatorio
                        </div>
                    </div>
            ...
            <div class="contenedor-1">
                <div class="form-2 row" action="">
                    <div class="col-4">
                        <input class=" controls form-control" type="search" name="nombres" id="largo" placeholder="INGRESAR PRODUCTO" required>
                        <div class="invalid-feedback">
                            Campo obligatorio
                        </div>
                    </div>
                    <div class="col-2">
                        <input class="peque controls form-control" type="number" name="apellidos" id="peque" placeholder="CANTIDAD" required>
                        <div class="invalid-feedback">
                            Campo obligatorio
                        </div>
                    </div>
                    <div class="col-2">
                        <input class="peque controls form-control" type="number" name="apellidos" id="peque" placeholder="PRECIO" required>
            ...
            <div class="contenedor-4">
                <div class="form-4 row" action="">
                    ...
                    <div class="col-12 d-flex justify-content-center align-items-center">
                        <input class=" controls" type="text" name="nombres" id="line1" placeholder="   TOTAL">
                    </div>
                </div>
                <div class="row" action="">
                    <div class="col-9">
