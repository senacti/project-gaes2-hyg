...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('SytleRegistroCliente.css') }}">
    <!-- Boostrap ---> 
...
<body class="body">
    ...
    <main>
        <form class="container needs-validation" novalidate>
            ...
            <div class="row">
                <div class="col-6">
                    <label for="TDocumento" class="email-imput">Tipo de documento</label>
                </div>
                <div class="col-6">
                    <label for="TDocumento">Numero de documento</label>
                </div>
            </div>
            <div class="row">
                <div class="col-6">
                    <input id="inputs" class="controls form-control" type="text" name="TDocumento" id="TDocumento" placeholder="Escriba su tipo de documento" required>
                    <div class="invalid-feedback">
                        Campo obligatorio
                    </div>
                </div>
                <div class="col-6">
                    <input id="inputs" class="controls form-control" type="text" name="TDocumento" id="TDocumento" placeholder="Escriba su numero de documento" required>
                    <div class="invalid-feedback">
                        Campo obligatorio
                    </div>
                </div>
            ...
            <!-- codigo postal y contacto de emergencia -->
            <div class="row" action="">
                <div class="col-6">
                    <label for="Cpostal" class="email-imput">Codigo postal</label>
                </div>
                <div class="col-6">
                    <label for="ContactoEmergencia">Coontacto de emergencia</label>
                </div>
            </div>
            <div class="row" action="">
                <div class="col-6">
                    <input id="inputs" class="controls form-control" type="number" name="Cpostal" id="Cpostal" placeholder="Escriba su codigo postal" required>
                    <div class="invalid-feedback">
                        Contraseña requerida
                    </div>
                </div>
                <div class="col-6">
                    <input id="inputs" class="controls form-control" type="number" name="ContactoEmergencia" id="ContactoEmergencia" placeholder="Escriba un numero de contacto" required>
                    <div class="invalid-feedback">
