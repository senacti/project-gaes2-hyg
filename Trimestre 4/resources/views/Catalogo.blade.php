...
<head>
    ...
    <link href="{{ asset('css/styleCatalogo.css') }}" rel="stylesheet">
</head>
    ...
    <main>
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3 row-cols-md-4 g-4">
                <div class="col">
                    <div class="card shadow-sm">
                        <img src="{{ asset('Iconos/Despensa.png') }}">
                        <div class="card-body">
                ...
                <div class="co2">
                    <div class="card shadow-sm">
                        <img src="{{ asset('Iconos/Lacteos.png') }}">
                        <div class="card-body">
                ...
                <div class="co3">
                    <div class="card shadow-sm">
                        <img src="{{ asset('Iconos/Bebidas.png') }}">
                        <div class="card-body">
                ...
                <div class="co4">
                    <div class="card shadow-sm">
                        <img src="{{ asset('Iconos/Limpieza.png') }}">
                        <div class="card-body">
        ...
        <div class="container1">
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3 row-cols-md-4 g-4">
                <div class="col">
                    <div class="card shadow-sm">
                        <img src="{{ asset('Iconos/Cuidado personal.png') }}">
                        <div class="card-body">
                ...
                <div class="co2">
                    <div class="card shadow-sm">
                        <img src="{{ asset('Iconos/Pasabocas.png') }}">
                        <div class="card-body">
                ...
                <div class="co3">
                    <div class="card shadow-sm">
                        <img src="{{ asset('Iconos/ProductosM.png') }}">
                        <div class="card-body">
